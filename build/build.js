...
(async function build() {
    ...
    const outFilePath = `${distDirPath}/azure-maps-layer-legend.js`;
    const outMinFilePath = `${distDirPath}/azure-maps-layer-legend.min.js`;

    const cssInPath = "./src/css/azure-maps-layer-legend.less";
    const cssOutPath = `${distDirPath}/azure-maps-layer-legend.css`;
    const cssOutMinPath = `${distDirPath}/azure-maps-layer-legend.min.css`;
